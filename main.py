...
def main():
    graph_file = 'hard_graphs/mycielski_7.col'
    ...
    for iteration in iteration_list:
        ...
        for i in range(10):
            ...
            colors, score = colony.optimize(problem_graph, num_ants=num_ants, num_iterations=iterations, heuristic_weight=0.5, pheromone_weight=4.0, evaporate_value=0.95, threads=16)
