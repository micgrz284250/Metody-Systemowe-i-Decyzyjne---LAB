...
def main():
    graph_file = 'instances/test_graphs/grid_20x20.col'
    ...
    for iteration in iteration_list:
        ...
        for i in range(10):
            ...
            colors, score = colony.optimize(problem_graph, num_ants=num_ants, num_iterations=iterations, heuristic_weight=4.0, pheromone_weight=2.0, evaporate_value=0.5, threads=8)
